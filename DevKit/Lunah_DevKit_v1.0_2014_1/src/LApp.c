...
int main()
{
	...
	Xil_Out32 (XPAR_AXI_GPIO_0_BASEADDR, 0);	// understand what this is doing
	Xil_Out32 (XPAR_AXI_GPIO_1_BASEADDR, 35);
	Xil_Out32 (XPAR_AXI_GPIO_2_BASEADDR, 131);
	Xil_Out32 (XPAR_AXI_GPIO_3_BASEADDR, 1513);
/*	Xil_Out32 (XPAR_AXI_GPIO_4_BASEADDR, 12);
	...
	//*******************enable the system **********************//
	/*Xil_Out32(XPAR_AXI_GPIO_18_BASEADDR, 0);	//enable the system, create a false event
	usleep(1);
